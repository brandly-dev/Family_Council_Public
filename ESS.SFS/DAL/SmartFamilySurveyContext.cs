    ...
    public partial class SmartFamilySurveyContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblPoolSurvey>(entity =>
            {
                ...
                entity.HasOne(d => d.PoolTemplate)
                    .WithMany(p => p.TblPoolSurvey)
                    .HasForeignKey(d => d.PoolTemplateId)
                    .HasConstraintName("FK_tblPoolSurvey_tblPool");

                entity.HasOne(d => d.Survey)
                    .WithMany(p => p.TblPoolSurvey)
                    .HasForeignKey(d => d.SurveyId)
                    .HasConstraintName("FK_tblPoolSurvey_tblSurvey");
            });
            ...
            modelBuilder.Entity<TblSurvey>(entity =>
            {
                ...
                entity.HasOne(d => d.Form)
                    .WithMany(p => p.TblSurvey)
                    .HasForeignKey(d => d.FormId)
                    .HasConstraintName("FK_tblSurvey_tblForm");
            });
            ...
            modelBuilder.Entity<TblUserSurvey>(entity =>
            {
                ...
                entity.HasOne(d => d.PoolSurvey)
                    .WithMany(p => p.TblUserSurvey)
                    .HasForeignKey(d => d.PoolSurveyId)
                    .HasConstraintName("FK_tblUserSurvey_tblPoolSurvey");

                entity.HasOne(d => d.Survey)
                    .WithMany(p => p.TblUserSurvey)
                    .HasForeignKey(d => d.SurveyId)
                    .HasConstraintName("FK_tblUserSurvey_tblSurvey");
            });
            //modelBuilder.Query<SearchUserSurvey>();
